...
import (
	...
	"github.com/hafidhadhi/training/golang-service/datastruct"
	"github.com/hafidhadhi/training/golang-service/logging"
	"github.com/hafidhadhi/training/golang-service/service"
...
func makeHelloDaerahEndpoint(aph AphService) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		...
		logging.Log(fmt.Sprintf("Name Request %s, %s, %s", req.NAME, req.GENDER, req.CITY))
